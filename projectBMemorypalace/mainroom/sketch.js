...
let closetIMG;  // Global var to load cow image
let bedIMG;
...
class MovableObject {
    ...
    display() {
        ...
        image(this.photo, this.x + offsetX - this.size / 2, this.y + offsetY - this.size / 2, this.size, this.size);
    }
...
//________________________________________________________________________________________________________________________
    ...
    // Initialize objects
    objects.push(new MovableObject(flowerIMG, 830, 162, 800, 'This is flower painting.'));
    objects.push(new MovableObject(closetIMG, 65, 407, 500, 'This is my closet.'));
    objects.push(new MovableObject(mattIMG, 605, 670, 500, 'This is my matt'));
    objects.push(new MovableObject(bedIMG, 605, 513, 600, 'This is my bed.'));
    objects.push(new MovableObject(teddyIMG, 648, 478, 100, 'This is my teddy bear.'));
    objects.push(new MovableObject(nhimIMG, 563, 478, 100, 'This is my stuffed hedgehog'));
